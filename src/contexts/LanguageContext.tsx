...
const translations = {
  en: {
    ...
    "dashboard.no_tasks_completed": "No completed tasks yet",
    "dashboard.no_tasks_pending": "No pending tasks",
    ...
    "dashboard.task_description_edit_placeholder":
      "Enter a description or use the 'Improve with AI' button...",
    ...
    "dashboard.chat": "Chat",
    "dashboard.add_new_task": "✨ Add New Task",
    "dashboard.error_title_required": "Please enter a task title first",
    "dashboard.error_improve": "Error improving description: ",
    "dashboard.error_unknown": "Unknown error",
  ...
  pt: {
    ...
    "dashboard.no_tasks_completed": "Nenhuma tarefa concluída ainda",
    "dashboard.no_tasks_pending": "Nenhuma tarefa pendente",
    ...
    "dashboard.task_description_edit_placeholder":
      "Digite uma descrição ou use o botão 'Melhorar com IA'...",
    ...
    // Chat
    "chat.title": "Intelligent Assistant",
    "chat.subtitle": "Ask anything about the application",
    "chat.placeholder": "Type your message...",
    "chat.send": "Send",
    "chat.thinking": "Assistant is thinking...",
    ...
    // Errors and Messages
    "error.general": "An error occurred. Please try again.",
    "error.login": "Invalid credentials. Check your email and password.",
